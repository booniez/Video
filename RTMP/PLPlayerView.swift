...
protocol PLControlViewDelegate: class {
    ...
    func controlView(controlView: PLControlView, speed: CGFloat)
...
class PLPlayerView: UIView, UIGestureRecognizerDelegate, PLControlViewDelegate {
    func controlViewRotate(controlView: PLControlView) {
...
//        self.gestureRecognizerShouldBegin(<#T##gestureRecognizer: UIGestureRecognizer##UIGestureRecognizer#>)
        ...
        controlView = PLControlView(frame: self.bounds)
